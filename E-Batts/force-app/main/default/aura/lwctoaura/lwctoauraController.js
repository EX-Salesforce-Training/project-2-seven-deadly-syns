({
	handleQty : function(component, event, helper) {
        ...
        console.log('v.rfqLine.Qty__c'); 
        console.log(v.qtyVar1);*/
	},
       ...
       const userId=(event.getParam('userVar'));
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                component.set('v.acctVar1',result[0].Id);
    ...
    let qty = component.get('v.qtyVar1');
    let aname=component.get('v.acctnameVar1');
    let dated = component.get('v.dateVar1');
    let prodid= component.get('v.prodVar1');
    let prodname= component.get('v.pnameVar1');
    let acId=component.get('v.acctVar1');
    let action=component.get('c.createRecord');
    
    action.setParams({'qty':qty,
    'aname':aname,
    'dated':dated,
    'prodid':prodid,
    'prodname':prodname,
    ...
    $A.enqueueAction(action);  
        component.set('v.qtyVar1','');
        component.set('v.acctnameVar1','');
        component.set('v.dateVar1','');
        component.set('v.prodVar1','');
        component.set('v.pnameVar1','');
        component.set('v.acctVar1','');
}
